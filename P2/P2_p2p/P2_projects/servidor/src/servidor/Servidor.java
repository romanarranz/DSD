...
public class Servidor implements IServidor{
    ...
    public void sendP2P(String destinatario, String remitente, String mensaje, String ip) throws RemoteException {
        if(conectados.containsValue(destinatario)){
            try{
                Registry registry = LocateRegistry.getRegistry();
                ICliente cliente = (ICliente) registry.lookup(destinatario);

                cliente.almacenarMensajeP2P(remitente, new Mensaje(mensaje, remitente));
